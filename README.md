...
# Using it through endpoint

* Host: https://gpt-crawler.infinityweb.app
* Method: `POST`
* Body
...
```typescript
{
    ...
    url: string,
        ...
        onVisitPage ? : (page: Page, pushData: (any) => Promise<void>) => Promise<void>,
...
* Authorization header: `Bearer ` + Date.now()
* Response: 200 OK
...
* POST https://gpt-crawler.infinityweb.app
* Header: Authorization = "Bearer 1634666666666"
* Body: `{"url": "https://clay.fish"}`
